            ...
            <div className="navbar text-white">
                <div className="navbar-start">
                    <div className="dropdown">
                        ...
                        <ul tabIndex={0} className="menu menu-compact dropdown-content mt-3 p-2 shadow bg-white colorGray font-semibold text-sm tracking-wider uppercase rounded-box w-52">
                            {menuItems}
                        </ul>
                    </div>
